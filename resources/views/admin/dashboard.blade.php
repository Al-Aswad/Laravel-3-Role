...
<head>
    ...
    <!-- Gijgo -->
    <link rel="stylesheet" href="{{url('backend')}}/libraries/css/gijgo.min.css">
    <!-- Style Css -->
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- datepiker -->
                    <input id="datepicker" width="276" readonly class="cu" />
                    <!-- datepiker -->
    ...
    <script src="{{url('backend')}}/libraries/js/gijgo.min.js"></script>
